 ...
 * 当同步完成时，缓存也就构建完成了。
 */
public class LoginSyncData {

    private static final String TAG = LoginSyncData.class.getSimpleName();
     ...
     * 调用时机：手动登录成功后，登录成功后mSyncStatus才开始改变
     *
     * 用于同步完成后关闭正在同步进度条
     *
     * @param observer 观察者
     ...
     * 单例
     */
    public static LoginSyncData getInstance() {
        return InstanceHolder.instance;
    }

    private static class InstanceHolder {
        final static LoginSyncData instance = new LoginSyncData();
    }
}
